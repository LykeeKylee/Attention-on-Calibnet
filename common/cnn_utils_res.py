...
# 生成权重矩阵
def weight_variable(shape, str, to_train=True):
    '''
    ...
    '''
    W = tf.get_variable("weight" + str, shape=shape, initializer=tf.contrib.layers.xavier_initializer(), trainable=to_train)
    return W
