...
dataset_seq = ['0001', '0002', '0005', '0009', '0011', '0013', '0014', '0015', '0017', '0018', '0019', '0020']

main_path_t = "./dataset_files/dataset/2011_09_26_drive_"
...
for seq in dataset_seq:
    ...
    for img_name, cloud_name in zip(imgs_files, point_files):
        ...
        current_img = cv.imread(img_name)
        ...
        # 点云投影到相机坐标系 00相机旋转矩阵(矫正)X雷达到相机变换矩阵X点云
        ...
        cv.imwrite(depth_maps_transformed_folder + "/" + img_name[-14:], reprojected_img)
        ...
        cv.imwrite(depth_maps_folder + "/" + img_name[-14:], pooled_img)
        cv.imwrite(target_img_folder + "/" + img_name[-14:], reconstructed_img)
